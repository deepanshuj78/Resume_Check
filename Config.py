...
TECH_SKILLS_BANK = {
    "languages": [
        "python", "java", "sql", "javascript", "typescript", "html", "css", "c++", "ruby", "go"
    ],
    "frameworks": [
        "react", "node.js", "node", "angular", "vue", "fastapi", "flask", "django", "express"
    ],
    "data_science": [
        "machine learning", "data science", "nlp", "pandas", "numpy", "pytorch", "tensorflow", "scikit-learn"
    ],
